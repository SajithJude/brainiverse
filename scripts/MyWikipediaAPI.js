...
MyWikipediaAPI.prototype.loadExample = function() {
    $("#wikiInfo").html("<h2>Click on any galaxy to start</h2><br/><p style='padding-right:10px'>");
    $("#wikiheader").empty()
};
...
// MyWikipediaAPI.prototype.fetchquiz = function() {
//     myThis=this;
//     $.getJSON("https://www.ncertbooks.guru/biology-mcqs-for-class-12-with-answers-chapter-1/", function(e) {
        
//             $("#quiz").html(qu.parse.text["*"]);
//         //     $("#fullScreenArticle").find("a:not(.references a)").attr("href", function() {
//         //         return $(this).attr("href")
//         //     });
//         //     $("#fullScreenArticle").find("a").removeAttr("href");
